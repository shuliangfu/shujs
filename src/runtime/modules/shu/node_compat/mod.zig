...
pub fn notImplementedCallback(
    ...
    const k_throw = jsc.JSStringCreateWithUTF8CString("__throw");
    defer jsc.JSStringRelease(k_throw);
    _ = jsc.JSObjectSetProperty(ctx, global, k_throw, exception, jsc.kJSPropertyAttributeNone, null);
